<template lang="pug">
	section.contacts(v-if="contacts")
		.contacts__box
			ul.contacts__list
				li.contacts__item.contacts__item_address(v-if="contacts.address")
					span.contacts__text {{contacts.address.text}}
					span.contacts__desc {{contacts.address.text_sup}}

				li.contacts__item.contacts__item_fax(v-if="contacts.fax")
					a(:href="contacts.address.url").contacts__text  {{contacts.address.text}}

				li.contacts__item.contacts__item_phone.contacts__item_phone-work(v-if="contacts.phone_work")
					span.contacts__text {{contacts.phone_work.text}}
				...
				li.contacts__item.contacts__item_phone.contacts__item_phone-home(:class="setClassEditor")
					...
					.contacts__editor
						editorInput(
							...
							:name="'phone_home'"
							:pattern="pattern")
				li.contacts__item.contacts__item_email(v-if="contacts.email")
					a(:href="contacts.email.url").contacts__text {{contacts.email.text}}

				li.contacts__item.contacts__item_skype(v-if="contacts.skype")
					a(:href="contacts.skype.url").contacts__text {{contacts.skype.text}}

				li.contacts__item.contacts__item_teams(v-if="contacts.teams")
					a(:href="contacts.teams.url").contacts__text {{contacts.skype.text}}
		.contacts__box
			blockSocials(class="contacts__socials" :socials="socials")
...
<script>
	...
	export default {
		...
		computed: {
			checkHomePhone() {
				return this.contacts.phone_home ? this.contacts.phone_home.text : "Заполнить"
			},
			setClassEditor() {
				return this.contacts.phone_home ? "" : "empty"
			}
		},
		methods: {
			onShowIcon() {
